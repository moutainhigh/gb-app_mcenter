          ...
          <div class="clearfix filter-wraper border-b-1">
            ...
            <div class="search-wrapper btn-group pull-right m-r-n-xs">
              <div class="input-group">
                ...
                <span class="input-group-btn"><soul:button target="query" opType="function" text="" cssClass="btn btn-filter _enter_submit" title="search"><i class="fa fa-search"></i><span class="hd">&nbsp;${views.common['search']}</span></soul:button></span>
              </div>
            </div>
