    ...
    <div class="modal-body">
        ...
        <div class="form-group clearfix">
            ...
            <div class="col-xs-9">
                ...
                <input name="indexName" class="form-control m-b-xs"/>
        ...
        <div class="form-group clearfix">
            ...
            <div class="col-xs-5" aria-disabled="true">
                <select class="chosen-select-no-single" name="indexPageUrl">
                    <c:forEach items="${command.domainTypes}" var="type">
                        <c:choose>
                            <c:when test="${type.defaultValue eq command.indexPageUrl}">
        ...
        <div class="form-group clearfix">
            <label class="col-xs-3 al-right line-hi34" >${views.column['CttDomain.domainLinkAddress']}：</label>
            <div class="col-xs-9">
                <input name="indexDomain" class="form-control m-b-xs"/>
        ...
        <div class="form-group clearfix">
            ...
            <div class="col-xs-9">
                ...
                <input name="managerName" class="form-control m-b-xs"/>
        ...
        <div class="form-group clearfix">
            <label class="col-xs-3 al-right line-hi34">${views.content['domain.typeTitle']}：</label>
            <div class="col-xs-5" aria-disabled="true">
                <select class="chosen-select-no-single" name="managerPageUrl">
                    <c:forEach items="${command.domainTypes}" var="type">
                        <c:choose>
                            <c:when test="${type.defaultValue eq command.managerPageUrl}">
                                <option value="${type.defaultValue}" selected>${views.content[type.resourceKey]}</option>
                            </c:when>
                        </c:choose>
                    </c:forEach>
        ...
        <div class="form-group clearfix">
            <label class="col-xs-3 al-right line-hi34" >${views.column['CttDomain.domainLinkAddress']}：</label>
            <div class="col-xs-9">
                <input name="managerDomain" class="form-control m-b-xs"/>
                <div class="co-grayc2"> ${views.content['indexdomain.edit.urlTitle']}</div>
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <soul:button target="${root}/content/sysDomain/saveSiteDomain.html" post="getCurrentFormData"   precall="validateForm" text="" opType="ajax" dataType="json" cssClass="btn btn-filter _search" callback="saveCallbak" tag="button">${views.common['confirm']}</soul:button>
