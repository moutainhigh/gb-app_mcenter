                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group date tooltip-demo">
                                ...
                                <form:input path="result.distanceValue" cssClass="form-control" maxlength="3"/>
                            ...
                            <div class="input-group date">
                                ...
                                <form:input path="result.distanceSide" cssClass="form-control" maxlength="3"/>
...
<!--//region your codes 4-->
<soul:import res="site/content/floatPic/ActivityEdit"/>
