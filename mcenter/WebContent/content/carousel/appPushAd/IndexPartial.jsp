        ...
        <table class="table table-striped table-hover dataTable" aria-describedby="editable_info">
            ...
            <c:forEach items="${command.result}" var="p" varStatus="status">
                <tr class="tab-detail">
                    ...
                    <td>
                        <soul:button target="${root}/content/cttCarousel/appPushAd/edit.html?search.id=${p.id}" text="${views.common['edit']}" tag="a" opType="dialog" callback="query">${views.common['edit']}</soul:button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
