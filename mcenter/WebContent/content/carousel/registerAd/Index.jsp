...
<!--//region your codes 1-->
<form:form action="${root}/content/vCttCarousel/viewRegister.html" method="post">
        ...
        <div class="col-lg-12">
            <div class="wrapper white-bg shadow">
                ...
                <div class="clearfix filter-wraper border-b-1 wrapper">
                    <soul:button target="${root}/content/cttCarousel/registerAd/create.html" callback="query"
