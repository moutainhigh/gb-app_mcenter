        ...
        <div class="col-lg-12">
            <div class="wrapper white-bg shadow">
                ...
                <div class="clearfix filter-wraper border-b-1">
                    <soul:button target="${root}/content/cttCarousel/msiteCarousel/create.html" callback="query" cssClass="btn btn-info btn-addon" text="${views.content['新增PC端首页轮播图']}" opType="dialog" tag="button">
