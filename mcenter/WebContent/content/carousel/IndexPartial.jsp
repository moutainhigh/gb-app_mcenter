...
<div class="table-responsive table-min-h">
    <table class="table table-striped table-hover dataTable" aria-describedby="editable_info">
        ...
        <tr role="row" class="bg-gray">
            ...
            <th class="inline">
                <gb:select name="search.type" value="${command.search.type}" callback="query"
                           prompt="${views.content['carousel.type']}" list="${command.types}"></gb:select>
            </th>
        ...
        <c:forEach items="${command.result}" var="p" varStatus="status">
            <tr>
                ...
                <td>
                    ${dicts.content.carousel_type[p.type]}
                </td>
                <td>
                ...
                <td>
                    <soul:button target="${root}/content/cttCarousel/edit.html?id=${p.id}" text="${views.common['edit']}" tag="a" opType="dialog" callback="query">${views.common['edit']}</soul:button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
