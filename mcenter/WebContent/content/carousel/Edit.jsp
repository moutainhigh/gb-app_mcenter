    ...
    <form:form>
        ...
        <div class="modal-body">
            <div class="form-group">
                <label>${views.content['carousel.type']}</label>
                <div class="input-group date tooltip-demo m-b-sm">
                    <gb:select name="result.type" prompt="${views.common['pleaseSelect']}" list="${command.types}"
                              callback="selectType" value="${command.result.type}" cssClass="_edit"></gb:select>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="clearfix col-sm-4">
                    <div  >
                        <div class="col-xs-3 p-x ${not empty command.result.type&&command.result.type=='carousel_type_player_index'?'':'hide'}" id="api-div">
                        ...
                        <div class="col-xs-8">
                            <div id="apiTypeId-div" class="${not empty command.result.type&&command.result.type=='carousel_type_player_index'&&not empty apiMap.apiTypeId?'':'hide'}">
                        ...
                        <%--<gb:select name="result.type" prompt="${views.common['pleaseSelect']}" list="${command.types}" cssStyle="width:100px"
                                   value="${command.result.type}" cssClass="_edit"></gb:select>
                        <gb:select name="result.type" prompt="${views.common['pleaseSelect']}" list="${command.types}"
                                   value="${command.result.type}" cssClass="_edit"></gb:select>--%>
                    </div>
                </div>
...
<soul:import res="site/content/carousel/Edit"/>
</html>