...
<form:form action="${root}/content/vCttCarousel/viewMobileDialog.html" method="post">
    <div id="validateRule" style="display: none">${command.validateRule}</div>
    <input type="hidden" name="result.type" value="${type}">
            <!--//region your codes 2-->
    <div class="row">
    ...
    <div class="col-lg-12">
        <div class="wrapper white-bg shadow">
            ...
            <div class="clearfix filter-wraper border-b-1">
                <soul:button target="${root}/content/cttCarousel/mobileDialog/create.html" callback="query" cssClass="btn btn-info btn-addon" text="${views.content['新增手机弹窗广告']}" opType="dialog" tag="button">
