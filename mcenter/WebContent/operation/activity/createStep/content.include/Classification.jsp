...
<div class="col-sm-5 input-group _i18n">
    ...
    <span class="bdn">
        <soul:button target="${root}/operation/activity/classificationManager.html" text="${views.operation['Activity.pop.manageClass']}" opType="dialog" title="${views.operation['Activity.pop.activityManageClass']}" cssClass="m-l-sm" callback="changeClassification"/>
    </span>
</div>
