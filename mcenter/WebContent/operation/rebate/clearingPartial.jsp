...
<div class="table-responsive">
    <table class="table table-striped table-hover dataTable m-b-none" aria-describedby="editable_info">
        ...
        <tr role="row" class="bg-gray">
            ...
            <%--<soul:orderColumn poType="${poType}" property="rebateTotal" column="${views.column['RebateAgent.rebateTotal']}"></soul:orderColumn>
            <soul:orderColumn poType="${poType}" property="rebateActual" column="${views.column['RebateAgent.rebateActual']}"></soul:orderColumn>--%>
        ...
        <tr class="bd-none hide">
            <th colspan="13">
                <div class="select-records"><i
                        class="fa fa-exclamation-circle"></i>${views.common['cancelSelectAll.prefix']}&nbsp;<span
                        id="page_selected_total_record"></span>${views.common['cancelSelectAll.middlefix']},
                    <soul:button target="cancelSelectAll" opType="function" text="${views.common['cancelSelectAll']}"/>${views.common['cancelSelectAll.suffix']}
                </div>
            </th>
        </tr>
        </thead>
        ...
        <c:forEach items="${command.result}" var="p" varStatus="status">
            ...
            <tr>
                <td><input type="checkbox" class="i-checks" value="${p.id}" data-use-status=""></td>
                ...
                <td class="co-blue">${p.effectivePlayer}</td>
                ...
                <td>${soulFn:formatCurrency(p.withdrawalAmount)}</td>
                <td>${soulFn:formatCurrency(p.rakeback)}</td>
                <td>${soulFn:formatCurrency(p.preferentialValue+p.recommend)}</td>
                ...
                <td class="${p.rebateTotal ge 0 ?"co-red":"co-green"}" style="padding-left: 40px">
                ...
                <td class="co-blue" style="padding-left: 25px">
                    <soul:button callback="allQuery"
                        ...
                        <span class="hd">${soulFn:formatCurrency(p.rebateActual)}</span>
                    </soul:button>
                </td>
            </tr>
        </c:forEach>
