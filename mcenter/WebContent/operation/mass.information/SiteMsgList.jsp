...
<form:form action="${root}/operation/massInformation/queryPlayerSiteMsg.html?search.receiverId=${command.search.receiverId}&search.receiveStatus=${command.search.receiveStatus}">
    <div class="row">
    ...
    <div class="col-lg-12">
        <div class="wrapper white-bg shadow search-list-container">
            <div class="dataTables_wrapper search-list-container">
                <%@include file="SiteMsgListPartial.jsp"%>
            </div>
        </div>
    </div>
    </div>
