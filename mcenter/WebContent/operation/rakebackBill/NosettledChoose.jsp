...
<%--@elvariable id="gametypes" type="java.util.Map<java.lang.Integer, java.util.Map<so.wwb.gamebox.model.master.operation.po.rakebackapinosettled>>"--%>
...
<form:form method="post">
    <input type="hidden" path="search.rakebackBillNosettledId" value="${command.search.rakebackBillNosettledId}"/>
