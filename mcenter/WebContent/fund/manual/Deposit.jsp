            ...
            <tr>
                ...
                <td>
                    <div class="table-desc-right-t width-response">
                        ...
                        <textarea class="form-control resize-vertical" placeholder="${views.fund_auto['多个账号，用半角逗号隔开']}" name="userNames" ${!empty transactionNo?'readOnly':''}>${username}</textarea>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-groups text-left">
                        <soul:button target="submit" precall="validateForm" msg="${views.fund['确认提交？']}" text="${views.fund_auto['确定']}" opType="function" cssClass="btn btn-filter p-x-lg m-r-md _enter_submit"/>
                    </div>
                </td>
            </tr>
            </tbody>
