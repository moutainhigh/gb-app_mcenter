...
<div class="panel-body p-sm">
    ...
    <table class="table no-border table-desc-list">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="result.rechargeAmount" class="form-control" style="width:25%;">
            </td>
        </tr>
        <tr>
        ...
        <tr id="favorableTr" style="display: none">
            <th scope="row" class="text-right">${views.fund['活动名称：']}</th>
            <td>
            ...
            <td>
                <div class="table-desc-right-t">
                    <select name="activityId">
                        <option value="">${views.fund_auto['请选择']}</option>
                        <c:forEach items="${sales}" var="i">
                            <option value="${i.activityMessageId}">${i.activityName}</option>
                        </c:forEach>
                    </select>
                    <span class="right-flo co-grayc2">
