    ...
    <div class="m-b-xs clearfix">
        <div class="col-sm-6 clearfix search_1" style="padding-left: 0;">
            ...
            <div class="form-group clearfix pull-left col-md-2 col-sm-12 m-b-sm padding-r-none-sm  hide senior checkUserName">
                <div class="input-group date">
                    <span class="input-group-addon bg-gray">${views.fund_auto['审核人']}</span>
            ...
            <div class="form-group clearfix pull-left col-md-2 col-sm-12 m-b-sm padding-r-none-sm  hide senior ipStr">
                <div class="input-group date">
                    <span class="input-group-addon bg-gray">&nbsp;&nbsp;${views.fund_auto['取款IP']}&nbsp;&nbsp;</span>
            ...
            <div class="form-group clearfix pull-left col-md-3 col-sm-12 m-b-sm padding-r-none-sm  hide senior rechargeAmount">
                <div class="input-group time-select-a">
                    ...
                    <input class="form-control search jp_distance" type="text" name="search.deductBeginAmount" value="${command.search.deductBeginAmount}"/>
                    <span class="input-group-addon time-select-t">~</span>
                    <span class="input-group-addon time-select-ico">${views.fund_auto['止']}</span>
                    <input class="form-control search jp_distance" type="text" name="search.deductEndAmount" value="${command.search.deductEndAmount}"/>
                </div>
            </div>
                            ...
                            <div class="btn-group table-desc-right-t-dropdown">
                                <ul role="menu">
                                    <li role="presentation">
                                        <label><input type="radio" value="" name="search.origin" ${empty command.search.origin?'checked':''}> ${views.fund_auto['全部']}</label>
                                    </li>
                                    <li role="presentation">
                                        <label><input type="radio" value="PC" name="search.origin" ${command.search.origin == 'PC'?'checked':''}>${views.fund_auto['PC端']}</label>
                                    </li>
                                    <li role="presentation">
                                        <label><input type="radio" value="MOBILE" name="search.origin" ${command.search.origin == 'MOBILE'?'checked':''}> ${views.fund_auto['手机端']}</label>
                                    </li>
                                </ul>
                            </div>
                        </span>
        ...
        <div class="col-sm-6 clearfix  search_2 m-b-xs">
            ...
            <div>
                <soul:button target="query" opType="function" text="${views.fund_auto['搜索']}" cssClass="btn btn-filter search_btn pull-left m-r-sm playerWithdrawSearch enter-submit"><i class="fa fa-search"></i><span class="hd">&nbsp;${views.fund_auto['搜索']}</span></soul:button>
            </div>
