...
<%@ page import="so.wwb.gamebox.model.DictEnum" %><%--@elvariable id="command" type="so.wwb.gamebox.model.master.fund.vo.VPlayerWithdrawListVo"--%>
...
<div class="m-t-md">
    <div class="m-b-xs clearfix">
        <div class="col-sm-6 clearfix search_1" style="padding-left: 0;">
            ...
            <%--来源终端--%>
            <div class="form-group clearfix pull-left col-md-2 col-sm-12 m-b-sm padding-r-none-sm senior hide origin">
                <div class="input-group">
