    ...
    <div class="modal-body">
        ...
        <div class="form-group clearfix line-hi34 m-b-sm col-xs-12">
            ...
            <div class="col-xs-8 p-x">
                <span class="co-orange">${soulFn:formatCurrency(command.result.rebateAmount)}</span>
                <input type="hidden" name="result.rebateAmount" value="${command.result.rebateAmount}">
            </div>
        </div>
        ...
        <div class="form-group clearfix line-hi34 m-b-sm col-xs-12">
            ...
            <div class="col-xs-8 p-x">
                <input type="text" class="form-control" name="result.rebateAmountActual">
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <soul:button target="${root}/fund/rebate/settled.html" text="${views.common['OK']}" opType="ajax" cssClass="btn btn-filter"
