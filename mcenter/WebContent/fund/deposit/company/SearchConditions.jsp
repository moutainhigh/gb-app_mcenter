...
<div class="m-t-md">
    <div class="m-b-xs clearfix">
        ...
        <div class="col-sm-9 clearfix  search_2 m-b-xs">
            ...
            <div>
                <soul:button target="queryByCondition" opType="function" text="${views.fund_auto['搜索']}" cssClass="btn btn-filter search_btn pull-left line-hi34 m-r-sm companySearcnSpan"><i class="fa fa-search"></i><span class="hd">&nbsp;${views.fund['搜索']}</span></soul:button>
            </div>
