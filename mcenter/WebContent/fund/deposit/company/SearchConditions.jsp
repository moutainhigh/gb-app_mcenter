    ...
    <div class="m-b-xs clearfix">
        ...
        <div class="col-sm-9 clearfix  search_2 m-b-xs">
            ...
            <div class="pull-right line-hi34 m-r-sm" hidden>${views.fund['今日成功']}<span class="co-red3">${siteCurrencySign}&nbsp;<span id="todayTotal">+0+</span></span></div>
                <soul:button target="query" opType="function" text="${views.fund_auto['搜索']}" cssClass="btn btn-filter search_btn pull-left m-r-sm companySearcnSpan"><i class="fa fa-search"></i><span class="hd">&nbsp;${views.fund['搜索']}</span></soul:button>
