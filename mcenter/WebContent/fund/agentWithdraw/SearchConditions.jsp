...
<div class="m-t-md">
    <div class="m-b-xs clearfix">
        ...
        <div class="col-sm-6 clearfix  search_2 m-b-xs">
            ...
            <div>
                <soul:button target="query" opType="function" text="${views.fund_auto['搜索']}" cssClass="btn btn-filter search_btn pull-left m-r-sm agentWithdrawSearch enter-submit"><i class="fa fa-search"></i><span class="hd">&nbsp;${views.fund_auto['搜索']}</span></soul:button>
            </div>
