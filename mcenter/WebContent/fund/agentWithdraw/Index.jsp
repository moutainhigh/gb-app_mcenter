...
<div class="row">
    <form:form action="${root}/fund/vAgentWithdrawOrder/agentList.html" method="post">
        <form:hidden path="search.agentId"/>
...
<script type="text/javascript">
    curl(["site/fund/agent/Agent",'gb/sysSearchTemplate/SysSearchTemplate','site/fund/FundSearch'], function(Page,SysSearchTemplate,FundSearch) {
        page =new Page();
