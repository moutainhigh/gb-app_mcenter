    ...
    <table class="table table-striped table-hover dataTable" id="editable" aria-describedby="editable_info">
        ...
        <c:forEach items="${command.result}" var="p" varStatus="status">
                <tr class="tab-detail">
                    ...
                    <td><a href="/player/list.html?search.hasReturn=true&search.agentId=${p.agentId}&search.createTimeBegin=${soulFn:formatDateTz(command.timeStart,DateFormat.DAY_SECOND,timeZone)}&search.createTimeEnd=${soulFn:formatDateTz(command.timeEnd,DateFormat.DAY_SECOND ,timeZone )}" nav-target='mainFrame'>${p.agentNewPlayerCount}</a></td>
                    <td data-value="&search.agentId=${p.agentId}"><a href="/player/list.html?search.hasReturn=true&search.agentId=${p.agentId}&startTime=${soulFn:formatDateTz(command.timeStart,DateFormat.DAY_SECOND,timeZone)}&endTime=${soulFn:formatDateTz(command.timeEnd,DateFormat.DAY_SECOND ,timeZone )}&rechargeCount=${command.depositParam.paramValue}&rechargeTotal=${command.depositCountParam.paramValue}&totalEffectiveVolume=${command.effectiveParam.paramValue}&analyzeNewAgent=true&searchType=2" nav-target='mainFrame'></a>
                        <soul:button target="effectivePlayerCount" text="${views.analyze_auto['分析']}" opType="function" cssClass="analyzeButton"/>
                    </td>
                    <td><a href="/player/list.html?search.hasReturn=true&search.agentId=${p.agentId}&startTime=${soulFn:formatDateTz(command.timeStart,DateFormat.DAY_SECOND,timeZone)}&endTime=${soulFn:formatDateTz(command.timeEnd,DateFormat.DAY_SECOND ,timeZone )}&analyzeNewAgent=true&searchType=3" nav-target='mainFrame'>${p.agentNewDepositPlayerCount}</a></td>
                    <td><a href="/report/vPlayerFundsRecord/fundsLog.html?search.hasReturn=true&search.agentid=${p.agentId}&analyzeStartTime=${soulFn:formatDateTz(command.timeStart,DateFormat.DAY_SECOND,timeZone)}&analyzeEndTime=${soulFn:formatDateTz(command.timeEnd,DateFormat.DAY_SECOND ,timeZone )}&analyzeNewAgent=true&searchType=1" nav-target='mainFrame'>${soulFn:formatCurrency(p.agentNewPlayerDepositCount)}</a></td>
                    <td><a href="/report/vPlayerFundsRecord/fundsLog.html?search.hasReturn=true&search.agentid=${p.agentId}&analyzeStartTime=${soulFn:formatDateTz(command.timeStart,DateFormat.DAY_SECOND,timeZone)}&analyzeEndTime=${soulFn:formatDateTz(command.timeEnd,DateFormat.DAY_SECOND ,timeZone )}&analyzeNewAgent=true&searchType=2" nav-target='mainFrame'>${soulFn:formatCurrency(p.agentNewPlayerWithdrawCount)}</a></td>
                    <td>${p.allDepositPlayerCount}</td>
                    <td><a href="/report/vPlayerFundsRecord/fundsLog.html?search.hasReturn=true&search.agentid=${p.agentId}&analyzeStartTime=${soulFn:formatDateTz(command.timeStart,DateFormat.DAY_SECOND,timeZone)}&analyzeEndTime=${soulFn:formatDateTz(command.timeEnd,DateFormat.DAY_SECOND ,timeZone )}&analyzeNewAgent=true&searchType=3" nav-target='mainFrame'>${soulFn:formatCurrency(p.allDepositCount)}</a></td>
                    <td><a href="/report/vPlayerFundsRecord/fundsLog.html?search.hasReturn=true&search.agentid=${p.agentId}&analyzeStartTime=${soulFn:formatDateTz(command.timeStart,DateFormat.DAY_SECOND,timeZone)}&analyzeEndTime=${soulFn:formatDateTz(command.timeEnd,DateFormat.DAY_SECOND ,timeZone )}&analyzeNewAgent=true&searchType=4" nav-target='mainFrame'>${soulFn:formatCurrency(p.allWithdrawCount)}</a></td>
