        ...
        <div class="clearfix col-lg-10">
            ...
            <div class="form-group clearfix pull-left content-width-limit-30 m-t-sm m-b-none role">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control list-search-input-text role" name="search.agentName" value="${command.search.playerName}" placeholder="${views.report['operate.search.account.hint']}">
                </div>
            </div>
        </div>
        <div class="col-lg-2">
            <div class="form-group clearfix m-t-sm m-b-none">
                ...
                <input type="hidden" name="subSysCode" value="<%=SubSysCodeEnum.PCENTER.getCode() %>" />
                <soul:button target="query" opType="function" text="${views.common['query']}" cssClass="btn btn-filter pull-right btn-search-css _enter_submit" />
            </div>
        </div>
    </div>
</div>