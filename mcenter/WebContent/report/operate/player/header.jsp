        ...
        <div class="clearfix col-lg-10">
            ...
            <div class="form-group clearfix pull-left content-width-limit-30 m-t-sm m-b-none role">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control list-search-input-text role" name="search.agentName" value="${command.userAgent.username}" placeholder="${views.report['operate.search.account.hint']}">
                </div>
            </div>
        </div>
        <div class="col-lg-2">
