        ...
        <div class="clearfix col-lg-10">
            ...
            <div class="form-group clearfix pull-left content-width-limit-30 m-t-sm m-b-none role">
                <div class="input-group">
                    ...
                    <gb:select name="role" list="${command.roles}" listKey="key" listValue="value" value="search.topagentName" callback="changeRole" prompt="" cssClass="chosen-select-no-single"/>
                    </span>
