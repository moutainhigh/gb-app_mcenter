...
<div class="m-t-md">
    <div class="m-b-xs clearfix">
            ...
            <div class="show-demand-a" style="${flag?'display:block':''}">
                ...
                <div class="form-group clearfix pull-left col-md-4 col-sm-12 m-b-sm padding-r-none-sm">
                    <div class="input-group time-select-a">
                        ...
                        <input class="form-control search" type="text" name="search.beginSingleAmount" value="${command.search.beginSingleAmount}">
                        <span class="input-group-addon time-select-t">~</span>
                        <span class="input-group-addon time-select-ico">${views.report_auto['止']}</span>
                        <input class="form-control search" type="text" name="search.endSingleAmount" value="${command.search.endSingleAmount}">
                    </div>
                </div>
                <%--有效投注额--%>
                <div class="form-group clearfix pull-left col-md-4 col-sm-12 m-b-sm padding-r-none-sm">
                    <div class="input-group time-select-a">
                        ...
                        <span class="input-group-addon time-select-ico">${views.report_auto['起']}</span>
                        <input class="form-control search" type="text" name="search.beginEffectiveTradeAmount" value="${command.search.beginEffectiveTradeAmount}">
                        <span class="input-group-addon time-select-t">~</span>
                        <span class="input-group-addon time-select-ico">${views.report_auto['止']}</span>
                        <input class="form-control search" type="text" name="search.endEffectiveTradeAmount" value="${command.search.endEffectiveTradeAmount}">
                    </div>
                </div>
                <%--派彩金额--%>
                <div class="form-group clearfix pull-left col-md-4 col-sm-12 m-b-sm padding-r-none-sm">
                    <div class="input-group time-select-a">
                        ...
                        <span class="input-group-addon time-select-ico">${views.report_auto['起']}</span>
                        <input class="form-control search" type="text" name="search.beginProfitAmount" value="${command.search.beginProfitAmount}"/>
                        <span class="input-group-addon time-select-t">~</span>
                        <span class="input-group-addon time-select-ico">${views.report_auto['止']}</span>
                        <input class="form-control search" type="text" name="search.endProfitAmount" value="${command.search.endProfitAmount}"/>
                    </div>
                </div>
                <%--派彩结果--%>
        ...
        <div class="col-sm-12 clearfix template-menu">
            ...
            <soul:button target="queryByCondition" opType="function" text="${views.report_auto['搜索']}" cssClass="btn btn-filter mediate-search-btn"/>
