...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="co-gray6">${views.report['fund.detail.refundfee']}</h3>
        </div>
            ...
            <table class="table no-border table-desc-list">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/report/vPlayerFundsRecord/fundsLog.html?search.outer=-1&search.userTypes=username&search.usernames=${command.result.username}&search.transactionWays=refund_fee&search.hasReturn=true" nav-target="mainFrame" class="btn btn-link" ><i class="iconfont icon-wanjiaguanli"></i>${views.report_auto['查询所有订单']}</a>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row" class="text-right">${views.report_auto['存款金额']}：</th>
                    <td>${siteCurrencySign}${soulFn:formatCurrency(empty command.depositMoney?0:command.depositMoney)}</td>
                </tr>
                <c:choose>
                ...
                <tr class="${tr_class}">
                    <th scope="row" class="text-right">${views.report_auto['返还手续费']}：</th>
