                                            ...
                                            <div class="btn-group table-desc-right-t-dropdown">
                                                <ul role="menu">
                                                    <li role="presentation">
                                                        <label><input class="allOrigin" type="radio"
                                                                      name="search.origin" value="">${views.report_auto['全部']}</label>
                                                    </li>
                                                    <li role="presentation">
                                                        <label><input type="radio" name="search.origin" value="PC">${views.report_auto['PC端']}</label>
                                                    </li>
                                                    <li role="presentation">
                                                        <label><input type="radio" name="search.origin" value="MOBILE">
                                                            ${views.report_auto['手机端']}</label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </span>
