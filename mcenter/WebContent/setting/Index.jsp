...
<form:form action="${root}/vRakebackSet/list.html" method="post">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <soul:button target="${root}/rakebackGrads/create.html" opType="dialog" text="${views.setting_auto['新增']}" cssClass="btn btn-default" />
                </div>
            </div>
