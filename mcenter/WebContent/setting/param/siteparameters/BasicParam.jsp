                    ...
                    <div class="col-lg-6 site-switch">
                        ...
                        <div class="content line-hi34 clearfix">
                            <div class="clearfix">
                                ...
                                <!--<a href="javascript:void(0)" class="m-l">${views.setting_auto['购买名称']}</a>-->
                            </div>
                            <div class="clearfix">
                        ...
                        <ul class="content clearfix">
                            <li class="clearfix">
                                <c:set value="${ fn:split(dicts.common.language[command.result.mainLanguage], '#') }"
                                       var="img"/>
                                <span class="m-r-sm control_state_1"><img class="m-r-sm" src="${resRoot}/${img[1]}">${dicts.common.nations[command.result.mainLanguage]}</span>
                                    ...
                                    <c:forEach items="${command.siteLanguageList}" var="lang" varStatus="status">
                                        ...
                                        <div tt="${lang.language}" style="display: ${status.index=='0'?'':'none'};width: 750px;margin-top: 30px;" name="result[${status.index}].content" class="clearfix contentSource ann m-b content${status.index} content${lang.language} contentVal${lang.language}" >
                                            ...
                                            <div class="clearfix m-b">
                                                ...
                                                <div class="col-xs-5">
                                                    <textarea  name="siteI18ns[${seoIndex}].value" class="form-control siteKeywords${lang.language}" placeholder="${views.setting['关键词1']}">${siteKeywords.get(lang.language).value}</textarea>
                                                </div>
                                            </div>
                                            <c:set var="seoIndex" value="${seoIndex+1}" />
                        ...
                        <div class="content line-hi34 clearfix">
                            ...
                            <div class="modal-footer">
                                <soul:button cssClass="btn btn-filter" text="${views.common['save']}" opType="ajax"
                                             ...
                                             precall="validateForm" post="getCurrentFormData" callback="saveCallbak"/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 site-switch">
                        ...
                        <ul class="content clearfix" style="padding-top: 10px">
                            <div class="clearfix m-b">
                                ...
                                <div class="col-xs-5"><input type="text" name="sms.fullName"
                                                             value="${smsInterfaceVo.result.fullName}"
                                                             class="form-control"></div>
                            </div>
                            <div class="clearfix m-b">
                                <div class="ft-bold pull-left line-hi34" style="width: 100px;text-align: right;">
                            ...
                            <div class="clearfix m-b">
                                <div class="ft-bold pull-left line-hi34" style="width: 100px;text-align: right;">${views.setting_auto['接口密钥']}：
                                </div>
                                <div class="col-xs-5">
