    ...
    <div class="modal-body">
        ...
        <div class="form-group clearfix line-hi34">
            ...
            <div class="input-group col-xs-8  line-hi34">
                ...
                <%--<form:select path="result.timeType" id="timeType" cssClass="btn-group chosen-select-no-single">
                ...
                <span class="stop ${command.result.timeType=='8'?'hide':''}">${views.setting_auto['截止']}：</span>
                <c:choose>
...
<soul:import res="site/setting/siteConfine/area/Edit"/>
</html>
