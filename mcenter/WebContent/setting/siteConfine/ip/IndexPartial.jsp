        ...
        <table class="table table-striped table-hover dataTable m-b-sm" id="editable" aria-describedby="editable_info">
            ...
            <c:forEach items="${command.result}" var="p" varStatus="status">
                <tr>
                    ...
                    <td>
                        <soul:button target="${root}/siteConfineIp/edit.html?id=${p.id}" dd="" size="open-dialog-50" text="${views.common['edit']}" cssClass="co-blue m-r-xs m-l-xs" opType="dialog" callback="query" />
                    </td>
                </tr>
            </c:forEach>
            </tbody>
