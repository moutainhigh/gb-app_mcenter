<%--@elvariable id="command" type="so.wwb.gamebox.model.master.setting.vo.VNoticeEmailInterfaceVo"--%>
...
<form:form id="editForm" action="${root}/vNoticeEmailInterface/edit.html" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group clearfix line-hi34 m-b-xxs">
            ...
            <div class="col-xs-8 p-x m-b rankStatus">
                ...
                <c:if test="${!command.result.builtIn}">
                    ...
                    <label class="m-r-sm"><input type="checkbox" class="i-checks all_rank">${views.setting['mail.Index.allRank']}</label>
                    </label><br>
                    <%--player rank--%>
                    <c:forEach items="${command.rankList}" var="playerRanks">
                        <label class="m-r-sm"><input type="checkbox" class="i-checks rank" name="rank"
        ...
        <div class="form-group clearfix line-hi34 m-b-xxs">
            ...
            <div class="col-xs-8 p-x"><input style="display: none"><form:password path="result.accountPassword" cssClass="form-control m-b"/></div>
        </div>
    </div>
