            ...
            <div class="wrapper white-bg shadow">
                ...
                <div class="sys_tab_wrap clearfix">
                    <div class="m-sm">
                        ...
                        <a href="javascript:void(0)" code="hklhc" class="label ssc-label">${views.lottery_auto['香港六合彩']}</a>
                        <a href="javascript:void(0)" code="bjpk10" class="label ssc-label">${views.lottery_auto['北京PK10']}</a>
                        <a href="javascript:void(0)" code="jsk3" class="label ssc-label">${views.lottery_auto['江苏快3']}</a>
