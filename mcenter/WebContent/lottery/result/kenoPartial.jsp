            ...
            <c:forEach items="${command.result}" var="p" varStatus="status">
                <tr class="tab-detail">
                    ...
                    <c:if test="${not empty p.openCode}">
                        ...
                        <td>${numSum}</td>
                        <td><c:if test="${numSum == 810}">和</c:if><c:if test="${numSum%2 == 0 && numSum != 810}">双</c:if><c:if test="${numSum%2 != 0}">单</c:if></td>
                        <td><c:if test="${numSum>810}">大</c:if><c:if test="${numSum < 810}">小</c:if><c:if test="${numSum == 810}">和</c:if></td>
                    </c:if>
