...
<div class="row">
  ...
  <div class="col-lg-12">
      <ul class="clearfix sys_tab_wrap" id="lotteryDiv">
          <li class="active" data-code="ssclottery" ><a href="javascript:void(0)">时时彩<span class="badge badge-blue m-l-sm">4种</span></a></li>
        ...
        <div class="clearfix m-t-md m-b-sm">
            ...
            <div class="col-lg-2">
                <div class="form-group clearfix m-b-none">
                    <soul:button target="query" opType="function" text="" cssClass="btn btn-filter pull-right _enter_submit">
