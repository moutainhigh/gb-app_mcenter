                    ...
                    <tr>
                        ...
                        <c:forEach items="${command.pl3_sanxing_zuxuan_hhzx}" var="p" >
                            <c:if test="${p.betNum eq '组三'}">
                                ...
                                <td>
                                    <div class="input-group content-width-limit-10">
                                        <input type="text" class="form-control input-sm rebate" placeholder="<=${odd.rebateLimit}" name="lotteryOdds[5].rebate" data-limit="${odd.rebateLimit}" data-value="${odd.rebate}" value="${odd.rebate}">
                                    </div>
                                </td>
                            </c:if>
                            <c:if test="${p.betNum eq '组六'}">
                                ...
                                <td>
                                    <div class="input-group content-width-limit-10">
                                        <input type="text" class="form-control input-sm rebate" placeholder="<=${odd.rebateLimit}" name="lotteryOdds[6].rebate" data-limit="${odd.rebateLimit}" data-value="${odd.rebate}" value="${odd.rebate}">
                                    </div>
                                </td>
                            </c:if>
                        </c:forEach>
                    ...
                    <tr>
                        <c:forEach items="${command.pl3_sanxing_zuxuan_zxhz}" var="p" >
                            <c:if test="${p.betNum eq '组三'}">
                                ...
                                <td>
                                    <div class="input-group content-width-limit-10">
                                        <input type="text" class="form-control input-sm rebate" placeholder="<=${odd.rebateLimit}" name="lotteryOdds[7].rebate" data-limit="${odd.rebateLimit}" data-value="${odd.rebate}" value="${odd.rebate}">
                                    </div>
                                </td>
                            </c:if>
                            <c:if test="${p.betNum eq '组六'}">
                                ...
                                <td>
                                    <div class="input-group content-width-limit-10">
                                        <input type="text" class="form-control input-sm rebate" placeholder="<=${odd.rebateLimit}" name="lotteryOdds[8].rebate" data-limit="${odd.rebateLimit}" data-value="${odd.rebate}" value="${odd.rebate}">
                                    </div>
                                </td>
                            </c:if>
                        </c:forEach>
