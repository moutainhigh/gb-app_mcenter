            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tr>
                        ...
                        <th><span>三星混合组选</span></th>
                        <c:set var="odd" value="${command.pl3_sanxing_zuxuan_hhzx}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
                                <input type="hidden" value="${odd[0].id}" name="lotteryOdds[5].id">
                                <input type="hidden" value="${odd[0].code}" name="lotteryOdds[5].code">
                                <input type="hidden" value="${odd[0].betCode}" name="lotteryOdds[5].betCode">
                                <input type="hidden" value="${odd[0].siteId}" name="lotteryOdds[5].siteId">
                                <input type="hidden" value="${odd[0].betNum}" name="lotteryOdds[5].betNum">
                                <input type="hidden" value="${odd[0].baseNum}" name="lotteryOdds[5].baseNum">
                                <input type="text" class="form-control input-sm odd" placeholder="<=${odd[0].oddLimit}" name="lotteryOdds[5].odd" data-limit="${odd[0].oddLimit}" data-value="${odd[0].odd}" value="${odd[0].odd}">
                            </div>
                        </td>
                        <td>
                            <div class="input-group content-width-limit-10">
                                <input type="text" class="form-control input-sm rebate" placeholder="<=${odd[0].rebateLimit}" name="lotteryOdds[5].rebate" data-limit="${odd[0].rebateLimit}" data-value="${odd[0].rebate}" value="${odd[0].rebate}">
                            </div>
                        </td>
                        <th><span>三星组选和值</span></th>
                        <c:set var="odd" value="${command.pl3_sanxing_zuxuan_zxhz}"/>
                        <td>
                            <div class="input-group content-width-limit-10">
                                <input type="hidden" value="${odd[0].id}" name="lotteryOdds[6].id">
                                <input type="hidden" value="${odd[0].code}" name="lotteryOdds[6].code">
                                <input type="hidden" value="${odd[0].betCode}" name="lotteryOdds[6].betCode">
                                <input type="hidden" value="${odd[0].siteId}" name="lotteryOdds[6].siteId">
                                <input type="hidden" value="${odd[0].betNum}" name="lotteryOdds[6].betNum">
                                <input type="hidden" value="${odd[0].baseNum}" name="lotteryOdds[6].baseNum">
                                <input type="text" class="form-control input-sm odd" placeholder="<=${odd[0].oddLimit}" name="lotteryOdds[6].odd" data-limit="${odd[0].oddLimit}" data-value="${odd[0].odd}" value="${odd[0].odd}">
                            </div>
                        </td>
                        <td>
                            <div class="input-group content-width-limit-10">
                                <input type="text" class="form-control input-sm rebate" placeholder="<=${odd[0].rebateLimit}" name="lotteryOdds[6].rebate" data-limit="${odd[0].rebateLimit}" data-value="${odd[0].rebate}" value="${odd[0].rebate}">
                            </div>
                        </td>
                    </tr>
                    </tbody>
