            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tr>
                        ...
                        <th><span>前三组三复式</span></th>
                        <c:forEach items="${command.ssc_sanxing_zuxuan_qsz3fs}" var="p" >
                            <td>
                        ...
                        <th><span>前三组三单式</span></th>
                        <c:forEach items="${command.ssc_sanxing_zuxuan_qsz3ds}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${lotteryIndex}].id">
                        ...
                        <th><span>前三组六复式</span></th>
                        <c:forEach items="${command.ssc_sanxing_zuxuan_qsz6fs}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${lotteryIndex}].id">
                    ...
                    <tr>
                        <th><span>前三组六单式</span></th>
                        <c:forEach items="${command.ssc_sanxing_zuxuan_qsz6ds}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${lotteryIndex}].id">
                        ...
                        <c:forEach items="${command.ssc_sanxing_zuxuan_qshhzx}" var="p" >
                            <c:if test="${p.betNum eq '组三'}">
                                <th><span>前三直选组合(组三)</span></th>
                                <td>
                                    <div class="input-group content-width-limit-10">
                                        <c:set var="odd" value="${p}"/>
                                        <input type="hidden" value="${odd.id}" name="lotteryOdds[${lotteryIndex}].id">
                    ...
                    <tr>
                        <c:forEach items="${command.ssc_sanxing_zuxuan_qszxhz}" var="p" >
                            <c:if test="${p.betNum eq '组三'}">
                            <th><span>前三组选和值(组三)</span></th>
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${lotteryIndex}].id">
                        ...
                        <c:forEach items="${command.ssc_sanxing_zuxuan_qszxbd}" var="p" >
                            <c:if test="${p.betNum eq '组三'}">
                            <th><span>前三组选包胆(组三)</span></th>
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${lotteryIndex}].id">
