        ...
        <div class="tab-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tbody>
                    <tr>
                        <th><span>任选二组选复式</span></th>
                        <c:forEach items="${command.ssc_renxuan2_zuxfs}" var="p" >
                            <td>
                        ...
                        <th><span>任选二组选单式</span></th>
                        <c:forEach items="${command.ssc_renxuan2_zuxds}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
                        ...
                        <th><span>任选二组选和值</span></th>
                        <c:forEach items="${command.ssc_renxuan2_zuxhz}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
