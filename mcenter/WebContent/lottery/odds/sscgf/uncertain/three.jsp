        ...
        <div class="tab-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tbody>
                    <tr>
                        <th><span>前三二码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_q3em}" var="p" >
                            <td>
                        ...
                        <th><span>前三一码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_q3ym}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
                        ...
                        <th><span>后三二码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_h3em}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
                    ...
                    <tr>
                        <th><span>后三一码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_h3ym}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
