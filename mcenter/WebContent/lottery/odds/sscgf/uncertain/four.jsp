        ...
        <div class="tab-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tbody>
                    <tr>
                        <th><span>前四二码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_q4em}" var="p" >
                            <td>
                        ...
                        <th><span>前四一码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_q4ym}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
                        ...
                        <th><span>后四二码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_h4em}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
                    ...
                    <tr>
                        <th><span>后四一码不定位</span></th>
                        <c:forEach items="${command.ssc_budingwei_h4ym}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
