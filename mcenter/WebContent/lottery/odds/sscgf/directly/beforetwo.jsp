        ...
        <div class="tab-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tbody>
                    <tr>
                        <th><span>前二直选复式</span></th>
                        <c:forEach items="${command.ssc_erxing_zhixuan_qefs}" var="p" >
                        <td>
                        ...
                        <th><span>前二直选单式</span></th>
                        <c:forEach items="${command.ssc_erxing_zhixuan_qeds}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
                        ...
                        <th><span>前二直选和值</span></th>
                        <c:forEach items="${command.ssc_erxing_zhixuan_qehz}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
                    ...
                    <tr>
                        <th><span>前二直选跨度</span></th>
                        <c:forEach items="${command.ssc_erxing_zhixuan_qekd}" var="p" >
                            <td>
                                <div class="input-group content-width-limit-10">
                                    <c:set var="odd" value="${p}"/>
                                    <input type="hidden" value="${odd.id}" name="lotteryOdds[${status.index}].id">
