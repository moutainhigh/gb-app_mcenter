        ...
        <div class="tab-content">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dataTable m-b-none text-center" aria-describedby="editable_info">
                    ...
                    <tbody>
                    <tr>
                        <th><span>${fn:replace(views.lottery_auto['个号码'],"[0]",5)}</span></th>
                        <td>
                        ...
                        <th><span>${fn:replace(views.lottery_auto['个号码'],"[0]",6)}</span></th>
                        <td>
                            <div class="input-group content-width-limit-10">
                        ...
                        <th><span>${fn:replace(views.lottery_auto['个号码'],"[0]",7)}</span></th>
                        <td>
                            <div class="input-group content-width-limit-10">
                    ...
                    <tr>
                        <th><span>${fn:replace(views.lottery_auto['个号码'],"[0]",8)}</span></th>
                        <td>
                            <div class="input-group content-width-limit-10">
                        ...
                        <th><span>${fn:replace(views.lottery_auto['个号码'],"[0]",9)}</span></th>
                        <td>
                            <div class="input-group content-width-limit-10">
                                <input type="hidden" value="${command['9个号码'].id}" name="lotteryOdds[4].id">
                                <input type="hidden" value="${command['9个号码'].code}" name="lotteryOdds[4].code">
                                <input type="hidden" value="${command['9个号码'].betCode}" name="lotteryOdds[4].betCode">
                                <input type="hidden" value="${command['9个号码'].siteId}" name="lotteryOdds[4].siteId">
                                <input type="hidden" value="${command['9个号码'].betNum}" name="lotteryOdds[4].betNum">
                                <input type="text" class="form-control input-sm" name="lotteryOdds[4].odd"
                                       value="${command['9个号码'].odd}">
                            </div>
                        </td>
                        <th><span>${fn:replace(views.lottery_auto['个号码'],"[0]",10)}</span></th>
                        <td>
                            <div class="input-group content-width-limit-10">
                                <input type="hidden" value="${command['10个号码'].id}" name="lotteryOdds[5].id">
                                <input type="hidden" value="${command['10个号码'].code}" name="lotteryOdds[5].code">
                                <input type="hidden" value="${command['10个号码'].betCode}" name="lotteryOdds[5].betCode">
                                <input type="hidden" value="${command['10个号码'].siteId}" name="lotteryOdds[5].siteId">
                                <input type="hidden" value="${command['10个号码'].betNum}" name="lotteryOdds[5].betNum">
                                <input type="text" class="form-control input-sm" name="lotteryOdds[5].odd"
                                       value="${command['10个号码'].odd}">
                            </div>
                        </td>
                    </tr>
