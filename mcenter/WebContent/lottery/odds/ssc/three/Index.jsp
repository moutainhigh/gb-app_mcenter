...
<div class="dataTables_wrapper" role="grid">
    <a style="display: none" href="javascript:void(0)" play="three" betCode="ten_thousand_thousand_hundred,ten_thousand_thousand_ten,ten_thousand_thousand_one,ten_thousand_hundred_ten,ten_thousand_ten_one,thousand_hundred_ten,thousand_hundred_one,thousand_ten_one,hundred_ten_one,ten_thousand_hundred_one" page="num"></a>
