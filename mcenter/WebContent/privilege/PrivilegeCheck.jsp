...
<html>
<head>
    <title>status-${views.privilege['密码']}</title>
...
<form:form>
    ...
    <div class="modal-body">
        ...
        <div class="form-group over clearfix">
            ...
            <%--<div><input type="checkbox" id="togglePassword"><label for="togglePassword">${views.privilege_auto['显示密码']}</label></div>--%>
        </div>
        <div id="privilegeTipDiv" class="form-group over clearfix hide">
            ...
            <div class="col-sm-12 p-x">
                <div class="col-sm-6 p-x">
                    <div>
                        <input class="form-control" type="text" name="valiCode" placeholder="${views.common['privilege.valicode.please']}" style="width: 70%;float: left;">
                        <img class="captcha-code" src="${root}/captcha/privilege.html?t=${random}" reloadable style="float: left;height: 34px;">
                        <soul:button cssClass="co-gray6 m-l" target="refreshCode" opType="function" text="refresh" style="float: left"><i class="fa fa-refresh"></i></soul:button>
                    </div>
                </div>
                <span class="help-block m-b-none"><i class="fa fa-times-circle co-red3"></i> ${views.common['privilege.password.prefix']}&nbsp;<span class="co-red3">0</span>&nbsp;${views.common['privilege.password.suffix']}</span>
            </div>
        </div>
    </div>
