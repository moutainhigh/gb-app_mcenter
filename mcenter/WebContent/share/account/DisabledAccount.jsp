...
<html>
    ...
    <body>
        <form:form>
            ...
            <div class="modal-footer">
                <soul:button target="toPreview" cssClass="btn btn-filter _edit" precall="validateForm" text="" opType="function">${views.common['optionAccount.submitAndPreview']}</soul:button>
    ...
    <script>
        curl(['site/share/account/DisabledAccount',"site/share/ReasonPreviewMore"], function(Page,ReasonPreviewMore) {
            page = new Page();
