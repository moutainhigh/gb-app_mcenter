...
<div class="row">
    <form:form action="${root}/simulationAccount/playerView.html" method="post">
        <div class="position-wrap clearfix">
            ...
            <span>${views.sysResource['角色']}</span><span>/</span><span>模拟账号</span>
            ...
            <div class="wrapper white-bg shadow">
                <div class="clearfix filter-wraper border-b-1">
                    <soul:button tag="button" cssClass="btn btn-info btn-addon" precall=""
                                 text="新增账号" target="${root}/simulationAccount/addPlayer.html"
                                 opType="dialog" callback="query">
                        <i class="fa fa-plus"></i>
                        <span class="hd">新增</span>
                    </soul:button>
                    <div class="function-menu-show">
                        <soul:button tag="button" target="${root}/simulationAccount/addQuota.html" precall="getIds" opType="dialog" text="增加额度"
                                     cssClass="btn btn-danger-hide _delete" callback="query">
                            <span class="hd">额度调整</span></soul:button>
