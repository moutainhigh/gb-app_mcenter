        ...
        <div class="col-lg-12">
            <div class="wrapper white-bg shadow">
                <ul class="artificial-tab clearfix">
                    ...
                    <li><a href="javascript:void(0)"><span class="no">2</span><span class="con">${views.role['PlayerRank.common.settings']}</span></a></li>
                    <input type="hidden" id="rankId" value="${rankId}">
                    <input type="hidden" id="strPayId" value="${strPayId}">
                </ul>
                <div class="rechargeCon">
                    ...
                    <dl class="list clearfix">
                        <dt>
                            <%--<img src="${resComRoot}/${banks[p.bankCode].bankIcon}"/>--%>
                                <span class="${banks[p.bankCode].type=='1'?'pay-bank ':'pay-third '} ${banks[p.bankCode].bankName}"></span>
                        <div>${dicts.common.bankname[p.bankCode]}</div>
                        </dt>
                        <dd class="col-xs-10">
                            </c:when>
                            ...
                            <div class="clearfix">
                                <div class="wh-110"><label><input type="checkbox" id="check_${p.id}" name="accountId" ${p.fullRank?'checked':''}
                                                                  value="${p.id}" class="i-checks"></label><b
                    ...
                    <div style="text-align: right;padding-right: 20px">
                        <button class="btn btn-outline btn-filter btn-lg payLimit">${views.role['PlayerRank.common.next']}</button>
                        <a href="" id="tot" nav-target="mainFrame" style="display: none">${views.role['common.settings']}</a>
                    </div>
                </div>
            </div>
        </div>
...
<soul:import res="site/player/playerrank/AddMoreAccount"/>
<!--//region your codes 4-->
