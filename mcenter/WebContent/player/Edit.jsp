    ...
    <form:form>
        ...
        <div class="modal-body">
            <div class="form-group clearfix line-hi34 m-b-xxs">
                <label class="col-xs-3 al-right">
                    <span class="co-red3 m-r-xs">*</span>
                        ${views.column['VPlayerRecharge.agentName']}
                </label>
            ...
            <div class="form-group clearfix line-hi34 m-b-xxs">
                <label class="col-xs-3 al-right">
                    <span class="co-red3 m-r-xs">*</span>
                        ${views.column['PlayerApiAccount.password']}
                </label>
                <div class="col-xs-8 p-x">
            ...
            <div class="form-group clearfix line-hi34 m-b-xxs" style="margin-bottom: 15px;">
                <label class="col-xs-3 al-right">
                    <span class="co-red3 m-r-xs">*</span>
                        ${views.column['VActivityPlayerApply.rankName']}
                </label>
                <div class="col-xs-8 p-x">
            ...
            <div class="clearfix line-hi34 hide" id="rakeback-div">
                <label class="col-xs-3 al-right">
                    ${views.column['VUserAgentManage.rakebackName']}
                </label>
            ...
            <div class="form-group clearfix line-hi34 m-b-xxs">
                <label class="col-xs-3 al-right">
                        ${views.column['VPlayerWithdraw.remark']}
                </label>
                <div class="col-xs-8 p-x">
