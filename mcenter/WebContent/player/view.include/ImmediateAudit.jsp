...
<form:form>
        ...
        <div class="audit-records-list m-sm" style="display: block;">
            ...
            <ul class="examine-list-modal">
                ...
                <c:if test="${fn:length(listVo)>0 && user.status ne '2'}">
                    ...
                    <soul:button permission="fund:playerwithdraw_clearAudit" cssClass="pull-right-examine clear-all hide-edit-field " opType="ajax" target="${root}/fund/withdraw/clearAudit.html"
    ...
    <div class="modal-footer">
        <c:if test="${fn:length(listVo)>0 && user.status ne '2'}">
        <soul:button permission="fund:playerwithdraw_clearAudit" cssClass="btn btn-filter btn-edit-audit" opType="ajax" target="${root}/fund/withdraw/clearAudit.html"
