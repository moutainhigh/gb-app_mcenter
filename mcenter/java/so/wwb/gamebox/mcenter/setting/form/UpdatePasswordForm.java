...
public class UpdatePasswordForm implements IForm {
    ...
    @NotBlank
    @Remote(checkClass = MyAccountController.class, checkMethod = "checkPassword", additionalProperties = {"password"}, message = "setting.myAccount.updatePassword.error")
    ...
    @Compare(message = "setting_auto.新密码不能与旧密码相同", logic = CompareLogic.NE, anotherProperty = "password")
