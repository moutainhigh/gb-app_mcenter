 ...
 */
public class RedTaskReminder extends PayTaskReminder {

    @Override
    public void setTaskReminder(UserTaskReminder userTaskReminder) {
        filterPayWarning(WarningTypeEnumEnum.RED_WARNING.getCode(),RechargeTypeParentEnum.COMPANY_DEPOSIT.getCode(),
                userTaskReminder);
    }
