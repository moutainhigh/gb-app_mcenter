 ...
 */
@Comment("活动规则首存送表单验证")
public class HallActivityRuleFirstDepositForm extends ActivityRuleForm {
...
//    @Series(message = "下一梯度要大于上一梯度",type = SeriesType.INC)
    ...
    @NotBlank(message = "operation_auto.请选择存款方式")
    public String getDepositWayStr() {
        return depositWayStr;
    }

    public void setDepositWayStr(String depositWayStr) {
        this.depositWayStr = depositWayStr;
    }
}
