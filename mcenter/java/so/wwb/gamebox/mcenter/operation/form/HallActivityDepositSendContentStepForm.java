...
import so.wwb.gamebox.mcenter.operation.hall.controller.HallActivityTypeController;

/**
 * Created by eagle on 15-9-1.
 */
@Comment("活动内容表单验证")
public class HallActivityDepositSendContentStepForm implements IForm {
