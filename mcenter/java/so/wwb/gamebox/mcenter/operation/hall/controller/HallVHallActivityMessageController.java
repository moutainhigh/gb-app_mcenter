...
@Controller
//region your codes 1
@RequestMapping("/activityHall/activity")
public class HallVHallActivityMessageController extends HallActivityController<IVActivityMessageService, VActivityMessageListVo,
...
//endregion your codes 1
    ...
    protected String getViewBasePath() {
        //region your codes 2
        return "/operation/activityHall/activity/";
    ...
    public Map activityRelease(ActivityTypeVo activityTypeVo, VActivityMessageVo vActivityMessageVo) {
        ...
        try {
            ...
            boolean success = ServiceActivityTool.vHallActivityMessageService().activityRelease(vActivityMessageVo);
