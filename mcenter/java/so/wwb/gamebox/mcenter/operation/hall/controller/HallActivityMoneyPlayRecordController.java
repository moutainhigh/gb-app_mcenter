...
@Controller
//region your codes 1
@RequestMapping("/activityHall/activityMoneyPlayRecord")
public class HallActivityMoneyPlayRecordController extends BaseCrudController<IActivityMoneyPlayRecordService, ActivityMoneyPlayRecordListVo, ActivityMoneyPlayRecordVo, ActivityMoneyPlayRecordSearchForm, ActivityMoneyPlayRecordForm, ActivityMoneyPlayRecord, Integer> {
//endregion your codes 1

    @Override
    protected String getViewBasePath() {
        //region your codes 2
        return "/operation/activityHall/activityMoneyPlayRecord/";
