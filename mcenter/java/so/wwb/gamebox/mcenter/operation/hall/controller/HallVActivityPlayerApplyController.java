 ...
 */
@Controller
@RequestMapping("/activityHall/vActivityPlayerApply")
public class HallVActivityPlayerApplyController extends BaseCrudController<IVActivityPlayerApplyService,
    ...
    private static final Log LOG = LogFactory.getLog(HallVActivityPlayerApplyController.class);
    private static final String PROP_ACTIVITY_INDEX = "/operation/activityHall/activity/activityPlayerApply/Index";
    private static final String PROP_ACTIVITY_SUCCESS_DIALOG = "/operation/activityHall/activity/activityPlayerApply/SuccessDialog";
    private static final String PROP_ACTIVITY_FAIL_DIALOG = "/operation/activityHall/activity/activityPlayerApply/FailDialog";

    @Override
    protected String getViewBasePath() {
        return "/operation/activityHall/activity/activityPlayerApply";
    }
