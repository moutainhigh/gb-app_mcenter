...
@Controller
//region your codes 1
@RequestMapping("/operation/rebate")
public class SettlementRebateController extends BaseCrudController<IRebateBillService, RebateBillListVo, RebateBillVo, RebateBillSearchForm, RebateBillForm, RebateBill, Integer> {
    ...
    public String rebateNosettled(Model model, HttpServletRequest request, RebateAgentNosettledListVo listVo) {
        ...
        if (rebateBillNosettled != null) {
            //查询返佣未出账单列表
            listVo.getSearch().setRebateBillNosettledId(rebateBillNosettled.getId());
