...
//endregion your codes 1
    ...
    @Remote(message = "content.floatPic.validate.disableAmount",checkMethod = "validToImprove",checkClass = so.wwb.gamebox.mcenter.content.controller.PayAccountController.class,additionalProperties = {"id"})
    //只能输入非零的正整数 ^\+?[1-9][0-9]*$
