...
@Controller
//region your codes 1
@RequestMapping("/activityMoneyCondition")
public class ActivityMoneyConditionController extends BaseCrudController<IActivityMoneyConditionService, ActivityMoneyConditionListVo, ActivityMoneyConditionVo, ActivityMoneyConditionSearchForm, ActivityMoneyConditionForm, ActivityMoneyCondition, Integer> {
